...
class WiiChuck {
    ...
    public:
        ...
        void calibrateJoy() {
            ...
            Serial.println();
            Serial.println();
            Serial.println(zeroJoyX);
            Serial.println(zeroJoyY);
            Serial.println();
            Serial.println();
        }
    ...
    int readJoyX4Servo() {
        return (int) constrain(map(readJoyX(), -90, 90, 0, 180), 0, 180);
        //return (int) constrain(map(joyX, JOY_X_LOW, JOY_X_HI, 0, 180), 0, 180);
    }

    int readJoyY4Servo() {
        return (int) constrain(map(readJoyY(), -90, 90, 0, 180), 0, 180);
        //return (int) constrain(map(joyY, JOY_Y_LOW, JOY_Y_HI, 0, 180), 0, 180);
    }
